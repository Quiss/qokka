...
return [
    ...
    */
    ...
    'openrouter' => [
        ...
        'analysis_fallback_model' => env('OPENROUTER_ANALYSIS_FALLBACK_MODEL', 'openai/gpt-5-mini'),
        'rewrite_model' => env('OPENROUTER_REWRITE_MODEL', 'google/gemini-3.6-flash'),
        'rewrite_fallback_model' => env('OPENROUTER_REWRITE_FALLBACK_MODEL', 'anthropic/claude-haiku-4.5'),
