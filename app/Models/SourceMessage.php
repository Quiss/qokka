 ...
 */
#[Fillable(['source_post_id', 'source_channel_id', 'external_message_id', 'telegram_grouped_id', 'text', 'entities', 'metrics', 'views', 'forwards', 'reactions', 'comments', 'raw_payload', 'posted_at', 'edited_at', 'deleted_at'])]
