 ...
 * @property string|null $advertising_description
 ...
 */
#[Fillable(['source_group_id', 'name', 'slug', 'language', 'timezone', 'tone_prompt', 'selection_prompt', 'advertising_description', 'tone_examples', 'forbidden_phrases', 'content_filters', 'analysis_model', 'rewrite_model', 'planning_time', 'safety_net_enabled', 'safety_net_cutoff_time', 'publish_window_start', 'publish_window_end', 'min_interval_minutes', 'max_interval_minutes', 'reserve_multiplier', 'media_caption_limit', 'show_source_attribution', 'signature_mode', 'signature_label', 'is_active'])]
