                ...
                Section::make('Основное')
                    ...
                    ->schema([
                        ...
                        Textarea::make('tone_prompt')
                            ...
                            ->helperText('Главная настройка стиля канала: задайте тон, объём, ритм, начало и финал, эмодзи, юмор и правила для разных тем. Доступная Telegram-разметка, достоверность и подпись контролируются приложением глобально — описывать их синтаксис здесь не нужно.')
                            ->rows(12)
                            ->autosize()
                            ->trim()
                            ->required()
