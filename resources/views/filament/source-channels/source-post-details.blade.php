<div class="flex flex-col gap-5">
    <div class="grid gap-3 sm:grid-cols-3">
        ...
        @else
            <section class="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-900 sm:col-span-2">
                <p class="text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400">Тип материала</p>
                <p class="mt-2 text-lg font-semibold text-gray-950 dark:text-white">JSON-подборка</p>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Социальные метрики для этого источника не применяются</p>
            </section>
        @endif
    </div>
